...
describe("Post authentication tasks", () => {
  ...
  const movieId = "ad41b6f6-d79f-4e58-89d6-9bb53498ccd9";

  test("Challenge 11.a - Similar movies using jaccard similarity", async () => {
    ...
    const response = await authenticatedSession
      .get(`/api/movie/${movieId}/similar?method=jaccard`)
